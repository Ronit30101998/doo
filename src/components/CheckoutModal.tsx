...
import { X, CreditCard, Banknote, Heart, Lock, CheckCircle } from 'lucide-react'
...
export default function CheckoutModal({ isOpen, onClose, cartItems }: CheckoutModalProps) {
  ...
  const paymentMethods = [
    ...
    },
    {
      ...
      icon: Heart,
      title: 'Complements',
      description: 'Pay with kind words and appreciation'
    }
  ]
          ...
          >
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                {selectedPayment === 'complements' ? 'Thank You!' : 'Payment Successful!'}
              </h3>
